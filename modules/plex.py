...
class Plex(Library):
    ...
    def needs_collection_mode_update(self, collection, mode):
        return int(collection.collectionMode) not in collection_mode_keys or collection_mode_keys[int(collection.collectionMode)] != mode
    ...
    def apply_batch_operations(
        self, *, label_edits, genre_edits, rating_edits, content_edits, studio_edits, date_edits, remove_edits, reset_edits, lock_edits, unlock_edits, ep_rating_edits, ep_remove_edits, ep_reset_edits, ep_lock_edits, ep_unlock_edits, name_display
    ):
