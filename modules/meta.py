                                ...
                                try:
                                    ...
                                    match auto_type:
                                        case "actor":
                                            ...
                                            the_list = actors
                                        case "director":
                                            director = [person for person in emby_people if person.get("Type") == "Director"]
                                            the_list = director
                                        case "writer":
                                            writers = [person for person in emby_people if person.get("Type") == "Writer"]
                                            the_list = writers
                                        case "composer":
                                            composers = [person for person in emby_people if person.get("Type") == "Composer"]
                                            the_list = composers
                                        case "producer":
